            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> <a href="{{ route('metar') }}">Lista Metars</a></li>
                        <li class="breadcrumb-item active">Formulario Registro</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <button type="submit" id="btn_guardar_ingreso" class="btn btn-success mt-4">Grabar
                                Ingreso</button>
                            <a href="{{ route('metar') }}" id="btn_salir_ingreso" class="btn btn-danger mt-4">Cancelar</a>
                        </div>
                        {{-- <div class="col-4">
                        ...
                        <div class="col">
                            ...
                            <select onchange="completarCatalgo()" class="select_id_catalogo_Modal form-control select2"
                                ...
                                @foreach ($estacion as $est)
                                    <option value="{{ $est['id'] }}">{{ $est['descripcion_catalogo'] }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
